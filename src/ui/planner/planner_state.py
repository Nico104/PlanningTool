...
from ...models.models import Semester, Raum, Lehrveranstaltung, Termin
from ...services.dataService import DataService
from ...services.filterService import filter_termine
from ...services.terminService import TerminService
